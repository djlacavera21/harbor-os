window.__HARBOR_STATION__ = true;
(() => {
  const FALLBACK = {
    official: [{id:"zen-garden",name:"FreshOS Zen Garden Edition",version:"1.4.0",download:"https://github.com/djlacavera21/harbor-os/archive/refs/heads/main.zip",source:"https://github.com/djlacavera21/harbor-os",flavor:"https://github.com/djlacavera21/harbor-os/blob/main/flavors/zen-garden/harbor.flavor.yaml",risk:"low",summary:"Mint overlay, Zen Garden visualizer, optional Grok Zen Master."}],
    community: [
      ...
      {id:"finance-harbor",name:"Finance Harbor",version:"0.1.0",download:"https://github.com/djlacavera21/harbor-os/archive/refs/heads/main.zip",source:"https://github.com/djlacavera21/harbor-os/tree/main/flavors/finance-harbor",risk:"unsigned",summary:"Local ledger and sovereignty-focused trade sketches."}
    ]
  };
